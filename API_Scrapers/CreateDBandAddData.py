...
try:
    ...
    mycursor.execute("use DBikeDynamic; CREATE TABLE DynamicBikeData (ID INT, AvailableBike INT, Capacity INT, Status VARCHAR(255),Location VARCHAR(255))")
except:
...
for i in numls:
    ...
    sql = "INSERT INTO DBikeDynamic.DynamicBikeData VALUES (%s,%s,%s,%s,%s)" 
